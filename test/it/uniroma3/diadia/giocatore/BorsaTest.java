...
public class BorsaTest {
	...
	public void testHasAttrezzoAttrezzoNonPresente() {
		assertEquals("Errore, l'attrezzo non � presente", false, this.borsaPiena.hasAttrezzo("quaderno"));
	}
	@Test
	public void testHasAttrezzoAttrezzoPresenteBis() {
		assertEquals("Errore, non ci sono proprio attrezzi qui", false, this.borsaVuota.hasAttrezzo("computer"));
	}

	@Test
	public void testHasAttrezzoAttrezzoSconosciuto() {
		assertEquals("Errore, l'attrezzo non esiste proprio", false, this.borsaPiena.hasAttrezzo("gomma"));
    }
	...
	public void testGetAttrezzoAttrezzoPresente() {
		assertEquals("Errore, l'attrezzo � presente", penna , this.borsaPiena.getAttrezzo("penna"));
	}

	@Test
	public void testGetAttrezzoAttrezzoNonPresente() {
		assertEquals("Errore, l'attrezzo non � presente", null, this.borsaPiena.getAttrezzo("quaderno"));
	}
	@Test
	public void testGetAttrezzoAttrezzoPresenteBis() {
		assertEquals("Errore, non ci sono proprio attrezzi qui", null, this.borsaVuota.getAttrezzo("computer"));
	}


	@Test
	public void testGetAttrezzoConAttrezzoSconosciuto() {
		assertEquals("Errore, l'attrezzo non esiste proprio", null , this.borsaPiena.getAttrezzo("gomma"));
